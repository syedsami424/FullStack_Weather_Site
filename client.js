        ...
        dropdown.addEventListener("change", function(){
            ...
            if(selectedOption=="None"){
                ...
                if(cityData){
                    ...
                    const temp_weatherButton= document.getElementById("getWeather");
                    temp_weatherButton.innerHTML="Get weather";
...
weatherButton.addEventListener("click",()=>{
    if(weatherButton.innerHTML=="Get weather"){
        weatherButton.innerHTML="Clear all";
        fetch(`http://localhost:5500/getWeather?lon=${lon}&lat=${lat}`)
        .then(response => response.json())
        .then(data => {
    ...
    else if(weatherButton.innerHTML=="Clear all"){
